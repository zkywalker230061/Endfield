...
# 想要查询的武器
query_weapon = "O.B.J.重荷"
# 不需要考虑的武器，比如已填充合适基质的武器
drop_weapons = [
    # 六星
    "不知归", "沧溟星梦", "宏愿", "大雷斑", "赫拉芬格", "负山",
    "熔铸火焰", "使命必达", "艺术暴君", "落草", "孤舟",
    "狼之绯", "赤缨", "四二式·肃阵", "曜夜的首演", "寒夜幽影",
    "镀红祝福",
    # 五星
    "仰止", "迷失荒野", "布道自由", "向心之引", "终点之声", "理性告别",
    "十二问", "古渠", "逐鳞3.0",
    # 四星
    "O.B.J.迅极", "O.B.J.轻芒", "O.B.J.尖峰", "O.B.J.术识",

    # 六星
    "典范", "扶摇", "J.E.T.", "热熔切割器", "昔日精品", "遥望",
    "白夜新星", "骑士精神", "领航者", "楔子", "同类相食", "爆破单元",
    "显赫声名",
    "黯色火炬", "作品：蚀迹", "望乡", "联结点", "黄金时代", "苦难的尽头",
    # 五星
    "作品：众生", "探骊", "悼亡诗", "嵌合正义", "莫奈何", "坚城铸造者",
    # 四星
    "浪潮", "淬火者", "工业零点一", "荧光雷羽", "长路", "呼啸守卫",
    "显锋", "天使杀手",
]
# 查询符合基质组合的武器
query_attributes = [
...
field_10 = {
    "基础": ["敏捷", "力量", "意志", "智识", "主能力"],
    "附加": ["攻击", "物理", "电磁", "寒冷", "自然", "暴击", "源石技艺", "法术"],
    "技能": ["压制", "追袭", "巧技", "残暴", "附术", "迸发", "流转", "效益"],
    "name": "应龙关"
}
field_11 = {
    "基础": ["敏捷", "力量", "意志", "智识", "主能力"],
    "附加": ["生命", "物理", "灼热", "自然", "暴击", "源石技艺", "法术", "治疗"],
    "技能": ["强攻", "压制", "追袭", "粉碎", "昂扬", "附术", "医疗", "效益"],
    "name": "北部禁区"
}
field_12 = {
    "基础": ["敏捷", "力量", "意志", "智识", "主能力"],
    "附加": ["攻击", "生命", "灼热", "电磁", "暴击", "终结技", "法术", "治疗"],
    "技能": ["强攻", "粉碎", "昂扬", "残暴", "医疗", "迸发", "夜幕", "流转"],
    "name": "雪松林"
}
field_map = {
    1: field_1,
